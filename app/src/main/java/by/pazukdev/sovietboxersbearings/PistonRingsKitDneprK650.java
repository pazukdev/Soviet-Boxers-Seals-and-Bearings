...
public class PistonRingsKitDneprK650 extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.piston_rings_kit_dnepr_k650);
        ...
        buttonReplacer.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(PistonRingsKitDneprK650.this,
