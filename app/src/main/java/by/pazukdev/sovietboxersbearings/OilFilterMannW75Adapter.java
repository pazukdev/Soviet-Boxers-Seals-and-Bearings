...
public class OilFilterMannW75Adapter extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.oil_filter_mann_w75_adapter);
        ...
        //button4 = (Button)findViewById(R.id.button_adapter);
