...
public class UnitFinalDriveK750 extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.unit_final_drive_k750);
        ...
        buttonBearing207.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(UnitFinalDriveK750.this,
                        Bearing207.class);
