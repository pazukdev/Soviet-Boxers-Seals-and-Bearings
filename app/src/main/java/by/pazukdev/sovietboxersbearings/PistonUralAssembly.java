...
public class PistonUralAssembly extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.piston_ural_assembly);
        ...
        buttonPiston.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(PistonUralAssembly.this,
                        PistonUral.class);
