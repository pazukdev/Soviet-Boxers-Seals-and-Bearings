...
public class UnitEngineMT10_36 extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.unit_engine_mt10_36);
        ...
        buttonBearing209Roller.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(UnitEngineMT10_36.this,
        ...
        buttonPistonKit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(UnitEngineMT10_36.this,
                        PistonDneprMT10_36Assembly.class);
                startActivity(intent);
            }
        });
