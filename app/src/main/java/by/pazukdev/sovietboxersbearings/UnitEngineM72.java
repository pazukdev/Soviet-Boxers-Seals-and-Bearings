...
public class UnitEngineM72 extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.unit_engine_m72);
        ...
        buttonBearingCamshaftBushingRear =
                (Button)findViewById(R.id.button_bearing_camshaft_bushing_rear);
        ...
        buttonBearing207.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(UnitEngineM72.this,
                        Bearing207.class);
        ...
        buttonBearing205.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(UnitEngineM72.this,
                        BearingCamshaftBearingFront.class);
                startActivity(intent);
            }
        });
