...
public class PistonDneprMT11Assembly extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.piston_dnepr_mt11_assembly);
        ...
        buttonPiston.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(PistonDneprMT11Assembly.this,
                        PistonDneprMT11.class);
