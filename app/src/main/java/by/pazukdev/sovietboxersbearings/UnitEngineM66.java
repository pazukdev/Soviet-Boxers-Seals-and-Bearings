...
public class UnitEngineM66 extends AppCompatActivity {
    private Button buttonBearing207;
    private Button buttonBearing207_2;
    private Button buttonBearing32207;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.unit_engine_m66);

        buttonBearing207 = (Button)findViewById(R.id.button_bearing_207);
        buttonBearing207_2 = (Button)findViewById(R.id.button_bearing_207_2);
        buttonBearing32207 = (Button)findViewById(R.id.button_bearing_32207);
        ...
        buttonBearing207_2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(UnitEngineM66.this,
                        Bearing207.class);
        ...
        buttonBearing32207.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(UnitEngineM66.this,
                        Bearing32207.class);
