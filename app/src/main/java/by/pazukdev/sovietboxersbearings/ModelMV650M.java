...
public class ModelMV650M extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.model_mv650m);
        ...
        buttonEngine.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(ModelMV650M.this,
        ...
        buttonSidecarReductionDrive.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ModelMV650M.this, UnitFinalDriveSidecarKMZ.class);
                startActivity(intent);
            }
        });
