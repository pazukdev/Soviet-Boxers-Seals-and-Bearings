...
public class UnitFinalDriveMod2wdMV750M extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.unit_final_drive_mod_2wd_mv750m);
        ...
        buttonBearingLeftDifferentialHub.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(UnitFinalDriveMod2wdMV750M.this,
        ...
        buttonBearing1DifferentialCover.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(UnitFinalDriveMod2wdMV750M.this, Bearing3086304L.class);
                startActivity(intent);
            }
        });
        ...
        buttonBearing2DifferentialCover.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(UnitFinalDriveMod2wdMV750M.this, Bearing204.class);
                startActivity(intent);
            }
        });
