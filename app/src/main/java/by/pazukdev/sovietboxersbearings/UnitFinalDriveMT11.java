...
public class UnitFinalDriveMT11 extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.unit_final_drive_mt11);
        ...
        buttonBearing207.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(UnitFinalDriveMT11.this,
                        Bearing207.class);
