...
public class PistonDneprK650Assembly extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.piston_dnepr_k650_assembly);
        ...
        buttonPiston.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(PistonDneprK650Assembly.this,
                        PistonDneprK650Assembly.class);
