...
public class ModelMV650 extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.model_mv650);
        ...
        buttonEngine.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(ModelMV650.this,
                        UnitEngineMT10.class);
        ...
        buttonSidecarReductionDrive.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ModelMV650.this, UnitFinalDriveSidecarKMZ.class);
                startActivity(intent);
            }
        });
