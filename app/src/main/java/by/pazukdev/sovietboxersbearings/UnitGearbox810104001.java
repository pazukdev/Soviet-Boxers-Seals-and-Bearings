...
public class UnitGearbox810104001 extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.unit_gearbox_8101_04001);
        ...
        buttonBearing1ClutchShaft.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(UnitGearbox810104001.this,
                        Bearing205.class);
        ...
        buttonSealGearboxKickstarterShaft.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(UnitGearbox810104001.this,
                        SealGearbox810104001Kickstarter.class);
                startActivity(intent);
            }
        });
