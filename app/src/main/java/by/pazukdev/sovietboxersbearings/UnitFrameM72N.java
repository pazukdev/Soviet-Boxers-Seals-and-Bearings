...
public class UnitFrameM72N extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.unit_frame_m72n);
        ...
        buttonBearing778707.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(UnitFrameM72N.this, Bearing778707.class);
        ...
        buttonBearing7204.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(UnitFrameM72N.this, Bearing7204.class);
                startActivity(intent);
        ...
        buttonBearingNeedleLever.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(UnitFrameM72N.this, BearingNeedleFrontForkK750.class);
                startActivity(intent);
            }
        });
        ...
        buttonSeal6206006.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(UnitFrameM72N.this, SealWheelHub.class);
                startActivity(intent);
        ...
        buttonSealSteeringHead1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(UnitFrameM72N.this, SealSteeringHeadK750Upper.class);
                startActivity(intent);
            }
        });
        ...
        buttonSealSteeringHead2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(UnitFrameM72N.this, SealSteeringHeadK750Lower.class);
                startActivity(intent);
            }
        });
