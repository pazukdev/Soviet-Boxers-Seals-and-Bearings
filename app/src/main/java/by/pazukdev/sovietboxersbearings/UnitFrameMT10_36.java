...
public class UnitFrameMT10_36 extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.unit_frame_mt10_36);
        ...
        buttonBearing778707.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(UnitFrameMT10_36.this, Bearing778707.class);
        ...
        buttonBearing7204.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(UnitFrameMT10_36.this, Bearing7204.class);
                startActivity(intent);
        ...
        buttonSeal6206006.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(UnitFrameMT10_36.this, SealWheelHub.class);
                startActivity(intent);
        ...
        buttonSealSteeringHead1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(UnitFrameMT10_36.this,
                        SealSteeringHeadMT10_36.class);
                startActivity(intent);
            }
        });
