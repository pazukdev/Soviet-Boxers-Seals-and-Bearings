...
public class UnitEngineK750M extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.unit_engine_k750m);
        ...
        buttonBearing207.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(UnitEngineK750M.this,
                        Bearing207.class);
