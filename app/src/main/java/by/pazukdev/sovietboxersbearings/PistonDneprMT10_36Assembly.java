...
public class PistonDneprMT10_36Assembly extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.piston_dnepr_mt10_36_assembly);
        ...
        buttonPiston.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(PistonDneprMT10_36Assembly.this,
                        PistonDneprMT10_36.class);
