...
public class SP_CardanShaftRing extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sp_cardan_shaft_ring);
        ...
        buttonReplacer.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(SP_CardanShaftRing.this,
                        SP_CardanShaftRingDIN.class);
