...
public class UnitFrameK750M extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.unit_frame_k750m);
        ...
        buttonBearing778707.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(UnitFrameK750M.this, Bearing778707.class);
        ...
        buttonBearing7204.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(UnitFrameK750M.this, Bearing7204.class);
                startActivity(intent);
        ...
        buttonSeal6206006.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(UnitFrameK750M.this, SealWheelHub.class);
                startActivity(intent);
        ...
        buttonSealSteeringHead1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(UnitFrameK750M.this, SealSteeringHeadK750Upper.class);
                startActivity(intent);
            }
        });
        ...
        buttonSealSteeringHead2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(UnitFrameK750M.this, SealSteeringHeadK750Lower.class);
                startActivity(intent);
            }
        });
